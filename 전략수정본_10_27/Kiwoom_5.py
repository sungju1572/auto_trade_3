        ...
        #매수 상태
            ...
            #2% 도달했으면
                ...
                if price <= low and buy_line == "하단선매수":
                    ...
                    self.ui.textEdit.setFontPointSize(13)
                    self.ui.textEdit.setTextColor(QColor(0,0,255))
                    self.ui.textEdit.append("■ 매도 : 시초가위 2%도달 후 하단선도달")
                    self.ui.textEdit.setFontPointSize(9)
                    self.ui.textEdit.setTextColor(QColor(0,0,0))
                ...
                if price <= middle  and buy_line == "중단선매수":
                    ...
                    self.ui.textEdit.setFontPointSize(13)
                    self.ui.textEdit.setTextColor(QColor(0,0,255))
                    self.ui.textEdit.append("■ 매도 : 시초가위 2%도달 후 중단선도달")
                    self.ui.textEdit.setFontPointSize(9)
                    self.ui.textEdit.setTextColor(QColor(0,0,0))
                ...
                if  price <= high  and buy_line == "상단선매수":
                    ...
                    self.ui.textEdit.setFontPointSize(13)
                    self.ui.textEdit.setTextColor(QColor(0,0,255))
                    self.ui.textEdit.append("■ 매도 : 시초가위 2%도달 후 상단선도달")
                    self.ui.textEdit.setFontPointSize(9)
                    self.ui.textEdit.setTextColor(QColor(0,0,0))
            ...
            if fluctuation_rate < 10 :
                if sell_status_1 =="초기상태" : 
                    ...
                    if compare >= sec_percent + 7:
                        ...
                        self.ui.textEdit_2.append("3%익절구간 도달 상태 | 종목 : " + name +" " +  str(compare))
                    ...
                    if compare >= sec_percent + 14:
                        ...
                        self.ui.textEdit.setFontPointSize(13)
                        self.ui.textEdit.setTextColor(QColor(0,0,255))
                        self.ui.textEdit.append("▶ 매도 : 14%익절구간 도달")  
                        self.ui.textEdit.setFontPointSize(9)
                        self.ui.textEdit.setTextColor(QColor(0,0,0))
                        self.ui.textEdit.append("->시간 : " + str(time) + " | " + "1매도 | "+ name +" | 14%익절구간 도달  ")
        ...
        #재매수상태
         ...
         #매수상태2
            ...
            if price <= low - 0.012*low and buy_line == "하단선매수":
                    ...
                    self.ui.textEdit.setFontPointSize(13)
                    self.ui.textEdit.setTextColor(QColor(0,0,255))
                    self.ui.textEdit.append("◀ 매도 : 하단선 밑 1.2% 도달")
                    self.ui.textEdit.setFontPointSize(9)
                    self.ui.textEdit.setTextColor(QColor(0,0,0))
            ...
            if price <= middle - 0.012*middle and buy_line == "중단선매수":
                    ...
                    self.ui.textEdit.setFontPointSize(13)
                    self.ui.textEdit.setTextColor(QColor(0,0,255))
                    self.ui.textEdit.append("◀ 매도 : 중단선 밑 1.2% 도달")
                    self.ui.textEdit.setFontPointSize(9)
                    self.ui.textEdit.setTextColor(QColor(0,0,0))
            ...
            if  price <= high - 0.012*high and buy_line == "상단선매수":
                    ...
                    self.ui.textEdit.setFontPointSize(13)
                    self.ui.textEdit.setTextColor(QColor(0,0,255))
                    self.ui.textEdit.append("◀ 매도 : 상단선 밑 1.2% 도달")
                    self.ui.textEdit.setFontPointSize(9)
                    self.ui.textEdit.setTextColor(QColor(0,0,0))
            ...
            if sec_percent < 10 :
                if sell_status_1 =="초기상태" : 
                    ...
                    if compare >= sec_percent + 14 :
                        ...
                        self.ui.textEdit.setFontPointSize(9)
                        self.ui.textEdit.setTextColor(QColor(0,0,0))
                        self.ui.textEdit.append("->시간 : " + str(time) + " | " + "2매도 | "+ name +" | 14%익절구간 도달  ")
            ...
            #시가등락률 10이상 20미만
                ...
                if sell_status_1 =="초기상태":
                    ...
                    if  compare >= (sec_percent+7):
                        ...
                        self.ui.textEdit.setFontPointSize(9)
                        self.ui.textEdit.setTextColor(QColor(0,0,0))
                        self.ui.textEdit.append("->시간 : " + str(time) + " | " + " (가) 2매도 | "+ name +" | 7%익절구간 도달 ")
            ...
            if fluctuation_rate < 10 :
                ...
                if sell_status_1 =="초기상태" : 
                    ...
                    if compare >= sec_percent + 14:
                        ...
                        self.ui.textEdit_2.append("7%익절구간 도달 상태 | 종목 : " + name +" " +  str(abs(sec_percent)+ compare))
